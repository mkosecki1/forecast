...
class ForecastRepositoryImpl(
    ...
    override suspend fun getFutureWeatherByDate(
        ...
        return withContext(Dispatchers.IO) {
            initWeatherData()
            return@withContext if (metric) futureWeatherDao.getDetailWeatherForecastsMetric(date)
            else futureWeatherDao.getDetailWeatherForecastsImperial(date)
        }
    }
    ...
    private suspend fun initWeatherData() {
        ...
        if (isFetchCurrentNeeded(lastWeatherLocation.zoneDataTime))
            fetchCurrentWeather()
